...
/**
 * Properties for TaskType Picker
 ...
 */
export interface ITaskTypePickerProps {
 ...
 */
export default function TaskTypePicker(props: ITaskTypePickerProps) {
    const taskTypes = ToArray(TaskType);
    function onChange(e) {
