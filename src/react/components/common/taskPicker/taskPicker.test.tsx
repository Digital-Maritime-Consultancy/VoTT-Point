...
import { TaskPicker, ITaskPickerProps, ITaskPickerState } from "./taskPicker";
...
describe("TaskPicker", () => {
    ...
    function createComponent(props: ITaskPickerProps):
            ReactWrapper<ITaskPickerProps, ITaskPickerState, TaskPicker> {
        return mount(<TaskPicker {...props}/>);
    }
    ...
    it("sets selected connection", async () => {
        ...
        const state = wrapper.find(TaskPicker).state();
